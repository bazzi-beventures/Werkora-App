...
export default function ErrorLogsScreen({ initialTenantId }: { initialTenantId?: string } = {}) {
  ...
  return (
    <div className="admin-page">
      <div className="admin-page-header">
        ...
        {/* Kopfzeilen-Aktionen: `.admin-btn` in Normalgroesse und in der
            zweiten Stufe — sie stellen die Ansicht ein und schreiben nichts.
            Die gefuellte Stufe bleibt der einen Schreibaktion eines Screens
            vorbehalten (Push senden, Newsletter senden). Vorher stand hier
            zweimal `admin-btn-sm`, daneben auf Service-Status und Push-Test ein
            eigener Knopf `.svc-refresh` und auf Werkora Bonus die Normalgroesse
            — drei Formen fuer dieselbe Sorte Aktion. */}
