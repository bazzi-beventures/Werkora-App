...
import { useKpiData } from '../../admin/kpis/useKpiData'
import { useDateRange } from '../../admin/hooks/useDateRange'
import { tickDM } from '../../admin/components/dateRange'
import DateRangeBar from '../../admin/components/DateRangeBar'
import KpiCards from '../../admin/kpis/components/KpiCards'
import DataTable from '../../admin/kpis/components/DataTable'
import BiBarChart from '../../admin/kpis/components/BiBarChart'
import type { ColumnDef, KpiNutzungAdoptionRow, KpiNutzungAktionRow } from '../../admin/kpis/types'
import {
  UNMAPPED, actionLabel, coverageNote, isPseudoModule, moduleCoverage, moduleLabel, moduleOfAction,
} from '../../admin/constants/usageTaxonomy'
import type { Coverage } from '../../admin/constants/usageTaxonomy'
...
interface Props {
   ...
   *  ModuleName: der kennt nur 19 der 25 Module (Spec §7f). Auf der
   *  Betreiber-Seite kommen sie aus der Mandantenliste des Wählers, nicht aus
   *  `/pwa/me` — dort steht der HEIMAT-Mandant des Betreibers
...
export default function UsageScreen({ enabledModules, tenantId = null }: Props) {
  ...
  const aktion = useKpiData<KpiNutzungAktionRow>('vw_kpi_nutzung_aktion', filters, tenantId)
  const adoption = useKpiData<KpiNutzungAdoptionRow>('vw_kpi_nutzung_adoption', undefined, tenantId)
